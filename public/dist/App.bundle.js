...
var striptags = __webpack_require__(160);

var $content = (0, _jquery2.default)('#jsonContent');

(0, _jquery2.default)(function () {
  _axios2.default.get('https://api.rss2json.com/v1/api.json?rss_url=https://chatbotsmagazine.com/feed').then(function (res) {
    var output = '';
    _jquery2.default.each(res.data.items, function (k, item) {
      var visibleSm;
      if (k < 6) {
        visibleSm = '';
      } else {
      ...
      output += '<div class="blog-element"><img class="img-responsive news-img" src="' + src + '" width="360px" height="240px"></div></header>';
...
(0, _jquery2.default)(function () {
  if (localStorage.getItem('feedback-message') === 'true') {
    (0, _jquery2.default)('.feedback-message').hide();
  } else {
    (0, _jquery2.default)('.feedback-message').show();
  }
});
...
var _dompurify = __webpack_require__(159);

var _dompurify2 = _interopRequireDefault(_dompurify);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function searchResultsHTML(chatbots) {
  return chatbots.map(function (chatbot) {
    return '\n      <a href="/chatbot/' + chatbot.slug + '" class="search__result">\n        <strong>' + chatbot.name + '</strong>\n      </a>\n    ';
  }).join('');
}
...
var _heart = __webpack_require__(139);
